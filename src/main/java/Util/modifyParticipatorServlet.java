...
@WebServlet(name = "modifyParticipatorServlet", value = "/modifyParticipatorServlet")
public class modifyParticipatorServlet extends HttpServlet {
    @Override
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ParticipatorService.CommitModifySql(pt);
